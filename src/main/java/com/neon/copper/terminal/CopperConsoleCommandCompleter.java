...
public class CopperConsoleCommandCompleter implements Completer {
    ...
    public void complete(LineReader reader, ParsedLine parsedLine, List<Candidate> candidates) {
        ...
        final ArgumentQueryResult queryResult = CommandParser.findEligibleArgument(
    sender,
    commandQueryResult.command(),
    commandQueryResult.args(),
    commandString,
    commandString.endsWith(StringUtils.SPACE),
    false,
    CommandSyntax::hasSuggestion,
    Argument::hasSuggestion
);
